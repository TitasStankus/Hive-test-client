...
public struct Generic : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_12_23(); }
  public static Generic GetRootAsGeneric(ByteBuffer _bb) { return GetRootAsGeneric(_bb, new Generic()); }
  public static Generic GetRootAsGeneric(ByteBuffer _bb, Generic obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Generic __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<HIVE.Commons.Flatbuffers.Generated.Generic> CreateGeneric(FlatBufferBuilder builder,
      ulong id = 0,
    ...
    Generic.AddId(builder, id);
    Generic.AddBoundingBox(builder, bounding_boxOffset);
    Generic.AddName(builder, nameOffset);
    Generic.AddSubscription(builder, subscription);
    Generic.AddRate(builder, rate);
    return Generic.EndGeneric(builder);
  }

  public static void StartGeneric(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<HIVE.Commons.Flatbuffers.Generated.Generic> EndGeneric(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<HIVE.Commons.Flatbuffers.Generated.Generic>(o);
  }
  public GenericT UnPack() {
    var _o = new GenericT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(GenericT _o) {
    _o.Id = this.Id;
    _o.Name = this.Name;
  ...
  public static Offset<HIVE.Commons.Flatbuffers.Generated.Generic> Pack(FlatBufferBuilder builder, GenericT _o) {
    if (_o == null) return default(Offset<HIVE.Commons.Flatbuffers.Generated.Generic>);
...
static public class GenericVerify
{
